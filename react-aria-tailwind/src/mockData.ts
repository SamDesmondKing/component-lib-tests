...
const LABELS = [
  ...
  'Company Name', 'Job Title', 'Department', 'Employee ID', 'Start Date',
  'Salary', 'Is Active', 'Country', 'City', 'Zip Code',
  'Notes', 'Priority', 'Category', 'Tags', 'Rating',
  'Description', 'URL', 'Age', 'Gender', 'Language',
  'Timezone', 'Currency', 'Amount', 'Quantity', 'Discount',
  'Tax Rate', 'Total', 'Status', 'Type', 'Source',
  'Channel', 'Campaign', 'Referral Code', 'Subscription', 'Plan',
]
